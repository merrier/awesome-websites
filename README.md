...
| [梗鲸·DeepSeek酱语录](https://ai-meme.cdqyfdbymn.me/) | DeepSeek 大肥鱼表情包图库：台词梗图按角色和情绪分类，详情页可下载原图或一键复制直接斗图，附角色三视图设定集与大肥鱼小游戏合集，免登录免费。 | `DeepSeek`、`表情包` |
| [海克斯小秘书](https://aramkit.cdqyfdbymn.me/) | 《英雄联盟》海克斯大乱斗（ARAM Mayhem）攻略站：全部 173 位英雄的胜率排行、六神装与技能加点、海克斯强化符文推荐，三源数据聚合每日更新，支持中英日韩等 12 种语言。 | `英雄联盟`、`游戏攻略` |
...
| [音乐搜索器](https://shenzjd.com/shenzjd/music/) | 多站合一音乐搜索解决方案，可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、喜马拉雅FM、全民K歌、5sing原创翻唱音乐。 | `音乐搜索` |
| [万象棋谱 WXHub](https://wxq.whatsyour.fun/) | 《王者荣耀》万象棋（自走棋）非官方玩家工具站：阵容编辑器拖拽调站位、英雄/装备/天赋/效果牌图鉴、伤害计算器与快速认卡练习，免注册打开即用。 | `王者荣耀`、`自走棋`、`游戏攻略` |
...
| [搜网盘](https://so.joestudy.net/) | 多网盘聚合搜索引擎，支持夸克网盘、阿里云盘、百度网盘资源搜索，免注册即用，实时搜索结果更新及时 | `网盘`、`搜索` |
